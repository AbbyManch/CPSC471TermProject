...
<input type ="hidden" id="status" value = "<%= request.getAttribute("status") %>">
    ...
    <div class="container">
        ...
        <form class="form form--hidden" id="forgotPassword">
            ...
            <div class="form__message">Enter your email and we'll send you a link to reset your password</div>

            <!--Email Container-->
            <div class="form__input-group">
                <input type="text" id="forgotEmail" class="form__input" autofocus placeholder="Email">
                <div class="form__input-error-message"></div>
            </div>
            ...
            <!--Login Link-->
            <p class="form__text">
                <a class="form__link" href="./" id="linkLogin">Back to Login Page</a>
            </p>
        </form>
